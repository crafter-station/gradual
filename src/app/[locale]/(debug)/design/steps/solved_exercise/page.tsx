import { ActiveSolvedExerciseStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/solved-exercise-step/active';
import { DoneSolvedExerciseStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/solved-exercise-step/done';
