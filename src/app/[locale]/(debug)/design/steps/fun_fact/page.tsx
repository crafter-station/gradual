import { ActiveFunFactStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/fun-fact-step/active';
import { DoneFunFactStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/fun-fact-step/done';
