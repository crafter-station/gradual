import { ActiveDefinitionStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/definition-step/active';
import { DoneDefinitionStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/definition-step/done';
