import { ActiveQuoteStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/quote-step/active';
import { DoneQuoteStep } from '@/app/[locale]/(app)/learn/courses/[course_id]/tasks/[task_id]/quote-step/done';
