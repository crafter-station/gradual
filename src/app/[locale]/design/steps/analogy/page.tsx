import { ActiveAnalogyStep } from '@/app/[locale]/courses/[course_id]/tasks/[task_id]/analogy-step/active';
import { DoneAnalogyStep } from '@/app/[locale]/courses/[course_id]/tasks/[task_id]/analogy-step/done';
