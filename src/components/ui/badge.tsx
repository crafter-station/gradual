  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring/20 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        red:
          'border-flexoki-red/20 bg-flexoki-red/10 text-flexoki-red hover:bg-flexoki-red/20 hover:border-flexoki-red/30',
        orange:
        ...
        blue:
          'border-flexoki-blue/20 bg-flexoki-blue/10 text-flexoki-blue hover:bg-flexoki-blue/20 hover:border-flexoki-blue/30',
        purple:
        ...
        pink:
          'border-flexoki-pink/20 bg-flexoki-pink/10 text-flexoki-pink hover:bg-flexoki-pink/20 hover:border-flexoki-pink/30',
        gray:
          'border-flexoki-gray/20 bg-flexoki-gray/10 text-flexoki-gray hover:bg-flexoki-gray/20 hover:border-flexoki-gray/30',
      },
    },
    defaultVariants: {
      variant: 'default',
